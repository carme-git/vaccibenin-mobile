...
// DONNÉES FICTIVES — à remplacer plus tard par l'API Laravel
// C'est ce qu'on recevra avec axios.get('/api/parent/dashboard')
const parentData = {
  nom: 'Kofi Mensah',
  enfants: [
    {
      ...
      age: '18 mois',
      avatar: '👧',
      progression: 75, // pourcentage de vaccins faits
      prochainVaccin: {
        nom: 'ROR (Rougeole)',
        date: '15 Avril 2026',
        centre: 'CSA Akpakpa',
      ...
      vaccins: [
        { id: 1, nom: 'BCG', date: 'Jan 2025', statut: 'fait' },
        { id: 2, nom: 'Polio 1', date: 'Fév 2025', statut: 'fait' },
        { id: 3, nom: 'Polio 2', date: 'Avr 2025', statut: 'fait' },
        { id: 4, nom: 'Pentavalent', date: 'Juin 2025', statut: 'fait' },
        { id: 5, nom: 'ROR', date: 'Avr 2026', statut: 'à_venir' },
        { id: 6, nom: 'Fièvre Jaune', date: 'Juin 2026', statut: 'à_venir' },
      ],
    },
    {
      id: 2,
      ...
      vaccins: [
        { id: 1, nom: 'BCG', date: 'Sep 2025', statut: 'fait' },
        { id: 2, nom: 'Polio 1', date: 'Oct 2025', statut: 'fait' },
        { id: 3, nom: 'Polio 2', date: 'Déc 2025', statut: 'retard' },
        { id: 4, nom: 'Polio 3', date: 'Avr 2026', statut: 'à_venir' },
      ],
    },
  ],
};
...
export default function DashboardParent({ navigation }) {
  ...
  // Enfant actuellement sélectionné (index dans le tableau)
  const [enfantActif, setEnfantActif] = useState(0);

  // Raccourci vers l'enfant sélectionné
  const enfant = parentData.enfants[enfantActif];
      ...
      <View style={styles.header}>
        <View style={styles.headerTop}>
          ...
          <View>
            ...
            <Text style={styles.nomParent}>{parentData.nom}</Text>
          </View>
          {/* Bouton notification */}
        ...
        <ScrollView horizontal showsHorizontalScrollIndicator={false} style={styles.enfantsScroll}>
          {parentData.enfants.map((e, index) => (
      ...
      <ScrollView style={styles.contenu} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.carteEnfant}>
          <View style={styles.carteEnfantTop}>
            <Text style={styles.carteAvatar}>{enfant.avatar}</Text>
            <View style={styles.carteInfos}>
              <Text style={styles.carteNom}>{enfant.prenom}</Text>
              <Text style={styles.carteAge}>{enfant.age}</Text>
            </View>
            {/* Pourcentage affiché en haut à droite */}
            <Text style={styles.cartePourcentage}>{enfant.progression}%</Text>
          </View>
          ...
          <View style={styles.progressBarre}>
            ...
            <View style={[styles.progressRempli, { width: `${enfant.progression}%` }]} />
          </View>
        </View>

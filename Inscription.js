// Inscription.js — Parents uniquement (Mère / Père) — 2 étapes
          ...
          <View style={styles.formulaire}>
            ...
            {etape === 1 && (
              <View>
                ...
                {/* Commune — filtré selon département */}
                <Selecteur
                  label="Commune *"
                  valeur={commune}
              ...
              <View>
                ...
                <View style={styles.otpSection}>
                  ...
                  {!otpEnvoye ? (
                    ...
                    <View>
                      {/* Affichage dev — à retirer en production */}
                      {otpDev !== '' && (
